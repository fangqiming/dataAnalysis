...
public interface HoldNowUsMapper extends BaseMapper<HoldNowUs> {
    ...
    @Update("update hold_now_us set amount = (old_price * amount)/#{cost} ,old_price = #{cost} where code = #{code}")
    void handleShareSplitUp(@Param("cost") BigDecimal cost, @Param("code") String code);
